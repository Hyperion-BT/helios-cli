...
var Helios = require("./Helios/helios");
var command_helpers_1 = require("./command_helpers");
...
program.command("compile")
    ...
    var func = Helios.compileHeliosProgram;
    if (options.data) {
...
program.command("deserialize")
    ...
    .action(function (file_path, options) {
    var func = Helios.deserializePlutusCoreBytes;
    if (options.bytes) {
...
program.command("dump")
    ...
    .option("-h, --hex", "Deserialize Plutus Core CBOR HexString.")
    .action(function (file_path, options) {
    var func = Helios.dumpPlutusCoreCborBytes;
    if (options.hex) {
...
program.command("tokenize")
    ...
    .action(function (file_path, options) {
    var func = Helios.tokenizeHelios;
    if (options.upll) {
